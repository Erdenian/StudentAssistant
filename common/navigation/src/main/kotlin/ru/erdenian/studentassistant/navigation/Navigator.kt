...
class Navigator(val state: NavigationState) {
     ...
     * 1. Если [route] — это текущий активный маршрут верхнего уровня: сбрасывает его стек до начального состояния (повторное нажатие на таб).
     * 2. Если [route] — это один из маршрутов верхнего уровня (но не текущий): переключает активный таб на этот маршрут.
