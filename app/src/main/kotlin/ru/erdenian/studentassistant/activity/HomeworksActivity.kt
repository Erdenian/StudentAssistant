...
class HomeworksActivity : AppCompatActivity(),
    ...
    override fun onScheduleUpdate() {
        ...
        toolbar_with_spinner_spinner.visibility =
                if (ScheduleManager.semesters.size > 1) View.VISIBLE else View.GONE
    ...
    override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
        ...
        view_pager.adapter =
                HomeworksPagerAdapter(supportFragmentManager, ScheduleManager.selectedSemesterId!!)
