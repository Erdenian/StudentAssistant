...
<p>Будильники “Student Assistant” позволяют напомнить пользователю о занятии за указанное время до начала занятия.
</p>
<p>Чтобы воспользоваться данной функцией перейдите в пункт боковой панели “Будильник”.
</p>
<p>Настройка будильника имеет простой интуитивный интерфейс, поэтому, если вы ознакомлены с пунктами работа с расписаниями, работа с домашними заданиями, то это окажется для вас простой задачей.
</p>
        """.trimMargin())
    }
