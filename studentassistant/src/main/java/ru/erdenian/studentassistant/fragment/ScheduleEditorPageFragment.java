 ...
 * @since 0.0.0
 */
public class ScheduleEditorPageFragment extends Fragment {

    static final String PAGE_SEMESTER_INDEX = "page_semester_index";
    static final String PAGE_WEEKDAY = "page_weekday";
    ...
    public static ScheduleEditorPageFragment newInstance(int semesterIndex, int weekday) {
        ScheduleEditorPageFragment schedulePageFragment = new ScheduleEditorPageFragment();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        List<Lesson> lessons = semester.getLessons(weekday);
