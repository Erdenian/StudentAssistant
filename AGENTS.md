...
* **Kover Plugin:** При добавлении тестов в модуль необходимо подключить плагин `alias(libs.plugins.kover)`, иначе
  модуль не будет учитываться в общем отчете о покрытии.
