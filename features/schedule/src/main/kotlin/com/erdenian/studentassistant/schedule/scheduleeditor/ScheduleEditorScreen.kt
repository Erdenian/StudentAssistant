...
internal class ScheduleEditorScreen(private val arguments: ScheduleScreen.ScheduleEditor) : Screen {

    @Composable
    override fun Content() {
        val viewModel = viewModel {
            findComponent<ScheduleApi, ScheduleComponent>().scheduleEditorViewModelFactory.get(arguments.semesterId)
        }
        ...
        ScheduleEditorContent(
            ...
            onEditSemesterClick = { navigator.push(ScreenRegistry.get(ScheduleScreen.SemesterEditor(viewModel.semesterId))) },
            onDeleteSemesterClick = { showDeleteSemesterDialog = true },
            onLessonClick = {
                navigator.push(
                    ScreenRegistry.get(
                        ScheduleScreen.LessonEditor(
            ...
            onAddLessonClick = { navigator.push(ScreenRegistry.get(ScheduleScreen.LessonEditor(viewModel.semesterId, it))) }
        )
    }
}
