...
internal class LessonEditorScreen(private val argument: ScheduleScreen.LessonEditor) : Screen {

    @Composable
    override fun Content() {
        val viewModel = viewModel {
            findComponent<ScheduleApi, ScheduleComponent>().lessonEditorViewModelFactory.getInternal(
                argument.semesterId,
                argument.lessonId,
                argument.copy,
                argument.dayOfWeek,
                argument.subjectName
            )
        }
